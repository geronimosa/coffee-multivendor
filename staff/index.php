...
?>
<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title><?= e($vendor['name']) ?> staff</title><link rel="stylesheet" href="/assets/css/super-admin.css"><?php if ($authorized): ?><meta http-equiv="refresh" content="15"><?php endif; ?></head><body class="<?= $authorized ? 'staff-queue' : '' ?>">
...
<?php else: ?><div class="actions fulfilment-head"><div><h1>Fulfilment queue</h1><p class="muted">Refreshes every 15 seconds</p></div><a class="button secondary" href="/shop/<?= e($slug) ?>" target="_blank">Customer shop</a></div>
