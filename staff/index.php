...
<?php endif; ?>
<?php if($vendorDescription!==''):?><footer class="card vendor-footer vendor-introduction" aria-label="About <?= e($vendor['name']) ?>"><?= $vendorDescription ?></footer><?php endif;?></main></body></html>
