...
?>
<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title><?=e($tab['table_name'])?> bill · <?=e($vendor['name'])?></title><link rel="stylesheet" href="/assets/css/super-admin.css?v=20260903-5"></head><body><header class="topbar"><a href="/vendor/<?=e($slug)?>/tables"><?=e($vendor['name'])?> · Tables</a><a href="/vendor/<?=e($slug)?>">Kitchen</a></header><main class="container"><div class="actions vendor-toolbar"><div><p class="section-kicker">Open table bill</p><h1><?=e($tab['table_name'])?></h1><p class="muted">Opened <?=e($tab['opened_at'])?> · <?=e(ucfirst($tab['status']))?></p></div><strong class="cashup-balance">R<?=number_format($outstanding,2)?> outstanding</strong></div>
