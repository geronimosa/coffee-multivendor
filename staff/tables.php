...
?>
<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Tables · <?=e($vendor['name'])?></title><link rel="stylesheet" href="/assets/css/super-admin.css?v=20260903-5"></head><body><header class="topbar"><strong><?=e($vendor['name'])?> · Staff</strong><?php vendor_portal_nav($pdo,$vendor,'tables')?><a href="/staff/logout.php?slug=<?=urlencode($slug)?>">Log out</a></header><main class="container product-admin"><div class="actions vendor-toolbar"><div><p class="section-kicker">Restaurant service</p><h1>Tables</h1><p class="muted">Each table has its own permanent ordering QR code.</p></div></div>
