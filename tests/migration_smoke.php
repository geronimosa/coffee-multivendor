...
try {
    ...
    foreach (['vendor_integrations', 'audit_logs', 'password_setup_tokens', 'edge_devices', 'edge_enrollment_tokens'] as $requiredTable) {
    ...
    foreach ([['restaurants', 'slug'], ['restaurants', 'theme_primary'], ['restaurants', 'hero_path'], ['restaurants', 'vendor_description'], ['users', 'password_hash'], ['orders', 'payment_status']] as [$table, $column]) {
